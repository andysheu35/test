...
def get_predicted_value(number):
    ...
    return (
        ...
        windspeed,
        performance * 100,
        float(real_power) + random.uniform(1, 10),
        beaufort,
    )


# def send_power_bi(power, times, windspeed, performance, real_power, beaufort):
#     url = "https://api.powerbi.com/beta/f572f9fa-fbc6-40b6-bb14-ccb10cd9a965/datasets/550ab59b-6d45-4c4d-9a00-d86852432a45/rows?redirectedFromSignup=1&key=e1n9RPNhjmkl1XPoUqZAVQ3ghTdmpcGag8UuFQZRoIkhnpWAXmUTdAL6d35ON0v01i3nuqGJQxqEnKpwh%2Bk6Xw%3D%3D"  # power bi url
#     payload = json.dumps(
#         [
#             {
#                 "timestamp": times,
