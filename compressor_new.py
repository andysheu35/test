...
def send_google_sheet(performance,motor,enter,exit,index):
    ...
    SAMPLE_SPREADSHEET_ID = "1VLtNqbZXJEmNZ9XqyKUMnEDrTCvbzBwacG-I2-KfAAA"
    ...
    try:
        ...
        aoa = [[performance,motor,enter,exit]]

        request = (
            sheet.values()
            .update(
                spreadsheetId=SAMPLE_SPREADSHEET_ID,
                range=f"sheet!Q{index}",
...
if __name__ == "__main__":
    ...
    #     send_google_sheet(
    #         performance,motor,enter,exit,index
    #     )
    #     number = number + 1
    #     index = index + 1
    #     if number > 200:
